...
object METFunctionsProvider : METProvider {
    ...
    init {
        ...
        metFunctions["walking"] = METFunction(lookupWalking)
        val lookupRunning = arrayOf(
            SpeedToMET(4.0, 6.0),
            SpeedToMET(5.0, 8.3),
            SpeedToMET(5.2, 9.0),
            SpeedToMET(6.0, 9.8),
        ...
        metFunctions["running"] = METFunction(lookupRunning)
        val lookupCycling = arrayOf(
            SpeedToMET(5.5, 3.5),
            SpeedToMET(9.4, 5.8),
            SpeedToMET(11.0, 6.8),
            SpeedToMET(13.0, 8.0),
        ...
        metFunctions["cycling"] = METFunction(lookupCycling)
    }
