...
public class StatsExperimentalFragment extends StatsFragment {
    ...
    public StatsExperimentalFragment(Context ctx) {
        super(R.layout.fragment_stats_experimental, ctx);
...
//        statsProvider.setAxisLimits(chart.getAxisLeft(), y);
        ...
        try {
            List<BubbleDataSet> bubbleSets = statsProvider.getExperimentalData(workoutTypeSelection.getSelectedWorkoutTypes(),
                    span,
